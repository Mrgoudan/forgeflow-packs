...
nullability, safe zones, initialization, traits, and generics — invoke the
relevant `bsc-*` skill for any BSC construct in the diff rather than
guessing. Read files in the checkout for context.
